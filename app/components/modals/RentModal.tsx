        ...
        bodyContent = (
            <div className="flex flex-col gap-8">
                <Heading
                    ...
                    subtitle="Ajude os hospedes a encontrarem seu imovel!"
                />
    ...
    if (step === STEPS.DESCRIPTION) {
        bodyContent = (
          <div className="flex flex-col gap-8">
            <Heading
              ...
              subtitle="Dê uma descrição breve!"
            />
            <Input
              id="title"
              label="Titulo"
      ...
      if (step === STEPS.PRICE) {
        bodyContent = (
          <div className="flex flex-col gap-8">
            <Heading
              title="Agora, diga o preço do seu imóvel :)"
              subtitle="Quantos você deseja por noite?"
            />
            <Input
              id="price"
              label="Valor"
